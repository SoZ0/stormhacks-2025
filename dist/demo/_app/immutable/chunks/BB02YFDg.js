import { F as create_text, x as block, ap as EACH_IS_CONTROLLED, C as set_hydrate_node, y as hydrating, aq as get_first_child, z as hydrate_next, g as get, a0 as derived_safe_equal, A as read_hydration_instruction, H as HYDRATION_START_ELSE, B as skip_nodes, D as set_hydrating, M as hydrate_node, ar as COMMENT_NODE, as as HYDRATION_END, G as branch, J as should_defer_append, at as EACH_ITEM_REACTIVE, au as EACH_INDEX_REACTIVE, I as current_batch, av as internal_set, Q as mutable_source, aw as source, ax as array_from, ay as is_array, K as resume_effect, L as pause_effect, az as EACH_ITEM_IMMUTABLE, aA as INERT, q as queue_micro_task, aB as destroy_effect, aC as EACH_IS_ANIMATED, aD as get_next_sibling, aE as pause_children, aF as clear_text_content, aG as run_out_transitions, _ as active_effect, e as effect, N as teardown, a8 as listen_to_event_and_reset_event, aH as select_multiple_invalid_value, aI as is, aJ as flatten, aK as LOADING_ATTR_SYMBOL, aL as NAMESPACE_HTML, aM as get_prototype_of, aN as ATTACHMENT_KEY, aO as get_descriptors, aP as is_capture_event, aQ as create_event, aR as delegate, aS as autofocus, aT as normalize_attribute, U as UNINITIALIZED, aU as add_form_reset_listener, aV as is_delegated } from "./T3HeJ6fH.js";
function index(_, i) {
  return i;
}
    ...
    if (hydrating) {
      ...
      if (should_defer_append()) {
        ...
        for (i = 0; i < length; i += 1) {
          value = array[i];
          key = get_key(value, i);
          var existing = (_a = state.items.get(key)) != null ? _a : offscreen_items.get(key);
          if (existing) {
...
function bind_select_value(select, get2, set = get2) {
  ...
  listen_to_event_and_reset_event(select, "change", (is_reset) => {
    ...
    if (select.multiple) {
      ...
      var selected_option = (_a = select.querySelector(query)) != null ? _a : (
...
function set_attributes(element, prev, next, css_hash, should_remove_defaults = false, skip_warning = false) {
  ...
  if (next[STYLE]) {
    (_a = next.style) != null ? _a : next.style = null;
  }
...
function get_attributes(element) {
  ...
  return (
    ...
    // @ts-expect-error
    (_a = element.__attributes) != null ? _a : element.__attributes = {
...
//# sourceMappingURL=BB02YFDg.js.map
