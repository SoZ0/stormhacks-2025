...
var _data, _form, _error, _params, _route, _state, _status, _url, _a, _current, _b, _current2, _c, _d, _e;
import { be as writable, ab as onMount, ao as state, g as get$1, T as set$1, bk as svelte, a9 as tick$1 } from "./T3HeJ6fH.js";
import { a as assets, b as base } from "./By-IGkRb.js";
class HttpError {
  /**
   * @param {number} status
...
function parent_element(element) {
  var _a2;
  let parent = (_a2 = element.assignedSlot) != null ? _a2 : element.parentNode;
...
function get_router_options(element) {
  ...
  return {
    preload_code: levels[preload_code != null ? preload_code : "off"],
    preload_data: levels[preload_data != null ? preload_data : "off"],
...
const scroll_positions = (_d = /* @__PURE__ */ get(SCROLL_KEY)) != null ? _d : {};
const snapshots = (_e = /* @__PURE__ */ get(SNAPSHOT_KEY)) != null ? _e : {};
const stores = {
...
async function start(_app, _target, hydrate) {
  ...
  if ((_a2 = globalThis.__sveltekit_1bpl1br) == null ? void 0 : _a2.data) {
    globalThis.__sveltekit_1bpl1br.data;
  }
  ...
  if (hydrate) {
    const navigation = {
      ...
      to: {
        ...
        route: { id: (_b2 = (_a2 = current.route) == null ? void 0 : _a2.id) != null ? _b2 : null },
...
function get_navigation_result_from_branch({ url, params, branch, status, error, route, form }) {
  ...
  if (page_changed) {
    result.props.page = {
      ...
      params,
      route: {
        id: (_a2 = route == null ? void 0 : route.id) != null ? _a2 : null
      },
      state: {},
      status,
      url: new URL(url),
...
async function load_node({ loader, parent, url, params, route, server_data_node }) {
  ...
  if ((_a2 = node.universal) == null ? void 0 : _a2.load) {
    ...
    const load_input = {
      ...
      data: (_b2 = server_data_node == null ? void 0 : server_data_node.data) != null ? _b2 : null,
      url: make_trackable(
        url,
        () => {
          if (is_tracking) {
    ...
    {
      data = (_c2 = await node.universal.load.call(null, load_input)) != null ? _c2 : null;
    }
  }
  return {
    node,
    ...
    universal: ((_d2 = node.universal) == null ? void 0 : _d2.load) ? { type: "data", data, uses } : null,
    data: (_e2 = data != null ? data : server_data_node == null ? void 0 : server_data_node.data) != null ? _e2 : null,
    slash: (_g = (_f = node.universal) == null ? void 0 : _f.trailingSlash) != null ? _g : server_data_node == null ? void 0 : server_data_node.slash
  };
}
...
function create_data_node(node, previous) {
  ...
  if ((node == null ? void 0 : node.type) === "skip") return previous != null ? previous : null;
  return null;
}
...
async function load_route({ id, invalidating, url, params, route, preload }) {
  ...
  const branch_promises = loaders.map(async (loader, i) => {
    ...
    const valid = (!server_data_node || server_data_node.type === "skip") && loader[1] === (previous == null ? void 0 : previous.loader) && !has_changed(
      ...
      url_changed,
      search_params_changed,
      (_a3 = previous.universal) == null ? void 0 : _a3.uses,
      params
    );
    ...
    if (loaders[i]) {
      try {
        ...
        if (server_data_nodes == null ? void 0 : server_data_nodes.includes(
          ...
          (_a2 = err.status) != null ? _a2 : status;
...
async function get_rerouted_url(url) {
  ...
  try {
    const promise = (async () => {
      var _a2;
      let rerouted2 = (_a2 = await app.hooks.reroute({
        url: new URL(url),
...
function handle_error(error, event) {
  ...
  return (_a2 = app.hooks.handleError({ error, event, status, message })) != null ? _a2 : (
    /** @type {any} */
    { message }
  );
}
...
function _start_router() {
  ...
  container.addEventListener("click", async (event) => {
    ...
    await navigate({
      ...
      keepfocus: options.keepfocus,
      noscroll: options.noscroll,
      replace_state: (_a3 = options.replace_state) != null ? _a3 : url.href === location.href,
      event
    });
  });
  ...
  addEventListener("popstate", async (event) => {
    ...
    if ((_a3 = event.state) == null ? void 0 : _a3[HISTORY_INDEX]) {
      ...
      const state2 = (_b2 = event.state[STATES_KEY]) != null ? _b2 : {};
      const url = new URL((_c2 = event.state[PAGE_URL_KEY]) != null ? _c2 : location.href);
...
async function _hydrate(target2, { status = 200, error, node_ids, params, route, server_route, data: server_data_nodes, form }) {
  ...
  try {
    ...
    result = get_navigation_result_from_branch({
      ...
      error,
      form,
      route: parsed_route != null ? parsed_route : null
    });
  } catch (error2) {
    if (error2 instanceof Redirect) {
...
function deserialize_uses(uses) {
  var _a2, _b2, _c2;
  return {
    dependencies: new Set((_a2 = uses == null ? void 0 : uses.dependencies) != null ? _a2 : []),
    params: new Set((_b2 = uses == null ? void 0 : uses.params) != null ? _b2 : []),
    parent: !!(uses == null ? void 0 : uses.parent),
    route: !!(uses == null ? void 0 : uses.route),
    url: !!(uses == null ? void 0 : uses.url),
    search_params: new Set((_c2 = uses == null ? void 0 : uses.search_params) != null ? _c2 : [])
  };
}
...
function reset_focus(url, scroll = null) {
  ...
  if (autofocus) {
    ...
    if (id && document.getElementById(id)) {
      const { x, y } = scroll != null ? scroll : scroll_state();
      setTimeout(() => {
  ...
  const navigation = (
    /** @type {any} */
    {
      from: {
        ...
        route: { id: (_b2 = (_a2 = current2.route) == null ? void 0 : _a2.id) != null ? _b2 : null },
        url: current2.url
      },
      to: url && {
        params: (_c2 = intent == null ? void 0 : intent.params) != null ? _c2 : null,
        route: { id: (_e2 = (_d2 = intent == null ? void 0 : intent.route) == null ? void 0 : _d2.id) != null ? _e2 : null },
        url
      },
      willUnload: !intent,
      type,
...
//# sourceMappingURL=DOBfrr44.js.map
